...
import { ScreenTint, WorldVignette, Motes, type LensProps } from '../core';
...
export function Aurora({ clock, w, h }: LensProps) {
  const curtains = [
    { x: w * 0.2, c: ['rgba(40,255,150,0)', 'rgba(40,255,150,0.55)', 'rgba(20,180,120,0)'], s: 0.5, b: 0 },
    { x: w * 0.42, c: ['rgba(120,120,255,0)', 'rgba(140,90,255,0.5)', 'rgba(80,40,200,0)'], s: 0.65, b: 1.4 },
    { x: w * 0.6, c: ['rgba(60,255,200,0)', 'rgba(40,230,180,0.55)', 'rgba(20,160,140,0)'], s: 0.45, b: 2.7 },
    { x: w * 0.8, c: ['rgba(200,120,255,0)', 'rgba(160,100,255,0.5)', 'rgba(90,40,180,0)'], s: 0.6, b: 4.1 },
  ];
  return (
    <>
